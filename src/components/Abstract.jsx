...
const abstractImages = [
  '/images/abstract/abstract.webp',
  '/images/abstract/abstract2.webp',
  '/images/abstract/abstract3.webp',
  '/images/abstract/abstract4.webp',
  '/images/abstract/abstract5.webp',
  '/images/abstract/abstract7.webp',
  '/images/abstract/abstract8.webp',
  '/images/abstract/abstract9.webp',
  '/images/abstract/abstract10.webp',
...
const Abstract = () => {
  return (
    <section className="bg-black text-white min-h-screen p-6 md:p-20">
      <h2 className="text-4xl md:text-6xl font-bold mb-10 text-center">3D ABSTRACT</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-14">
        {abstractImages.map((src, idx) => (
          <div
            key={idx}
