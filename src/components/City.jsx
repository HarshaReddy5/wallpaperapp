...
const regularCityWallpapers = [
  { name: 'city1', ext: 'jpg' },
  { name: 'city5', ext: 'jpg' },
];

const eightKCityWallpapers = [
  'city2', 'city3', 'city4', 'city6', 'city8'
];
  ...
  return (
    <section className="bg-black text-white min-h-screen p-6 md:p-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-14">
        {regularCityWallpapers.map(({ name, ext }, idx) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-14">
        {eightKCityWallpapers.map((name, idx) => {
          const webpPath = `/images/city/${name}.webp`;
      ...
      <div className="flex justify-center mt-10">
        <motion.a
          ...
          whileInView="visible"
          viewport={{ once: true }}
          href="https://harshared.lemonsqueezy.com/buy/985b9ed2-fdcc-4db4-82ef-d2dcb34866ce"
          target="_blank"
