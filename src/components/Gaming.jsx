...
const eightKWallpapers = [
  {
    ...
    download: '/images/gaming/8kgaming/gaming13.png',       
  },
  {
      preview:  '/images/gaming/gaming14.jpg',  
    download: '/images/gaming/8kgaming/gaming14.png',
  },
  {
      preview:  '/images/gaming/gaming8.jpeg',  
    download: '/images/gaming/8kgaming/gaming8.png',
  },
    {
      preview:  '/images/gaming/gaming9.jpeg',  
    download: '/images/gaming/8kgaming/gaming9.png',
  },
    {
      preview:  '/images/gaming/gaming10.jpeg',  
    download: '/images/gaming/8kgaming/gaming10.png',
  },
    {
      preview:  '/images/gaming/gaming11.jpeg',  
    download: '/images/gaming/8kgaming/gaming11.png',
  },
     {
      preview:  '/images/gaming/gaming5.png',  
    download: '/images/gaming/8kgaming/gaming5.png',
  },
];
...
const handleShare = async (url) => {
  if (navigator.share) {
    try {
      await navigator.share({ title: 'Check out this wallpaper!', url: window.location.origin + url });
    } catch (err) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-14">
        {gamingImages.map((src, idx) => (
          <div key={idx} className="rounded-xl border border-white/10 overflow-hidden bg-white/5">
            <img src={src} alt={`gaming-${idx}`} className="w-full h-64 object-cover hover:scale-105 transition-transform duration-500" />
            <div className="flex flex-col sm:flex-row justify-center gap-4 p-4">
              <a href={src} download className="relative px-5 py-2 bg-white text-black text-xs font-mono uppercase tracking-wide group overflow-hidden"
                style={{ clipPath: 'polygon(8% 0, 100% 0, 100% 92%, 92% 100%, 0 100%, 0 8%)' }}>
                <span className="relative z-10">Download</span>
                <span className="absolute left-0 top-0 h-full w-0 bg-[#ff7300] transition-all duration-500 ease-in-out group-hover:w-full z-0" />
              </a>
              <button onClick={() => handleShare(src)} className="relative px-5 py-2 bg-white text-black text-xs font-mono uppercase tracking-wide group overflow-hidden"
                style={{ clipPath: 'polygon(8% 0, 100% 0, 100% 92%, 92% 100%, 0 100%, 0 8%)' }}>
  ...
  {eightKWallpapers.map(({ preview, download }, idx) => (
    <div key={idx} className="rounded-xl border border-white/10 overflow-hidden bg-white/5">
      ...
      <div className="flex justify-center">
        <motion.button variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
