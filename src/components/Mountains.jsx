...
const mountainImages = [
  '/images/mountain/Mountain3.webp',
];

const eightKWallpapers = [
  { preview: '/images/mountain/m1.webp' },
  { preview: '/images/mountain/m2.webp' },
  { preview: '/images/mountain/m3.webp' },
  { preview: '/images/mountain/m4.webp' },
 { preview: '/images/mountain/m5.webp' },
 { preview: '/images/mountain/m6.webp' },,
 { preview: '/images/mountain/m7.webp' },
  { preview: '/images/mountain/m8.webp' },
];
    ...
    <section className="bg-black text-white min-h-screen p-6 md:p-20">
      ...
      <div className="flex justify-center mt-10">
        <motion.a
          ...
          whileInView="visible"
          viewport={{ once: true }}
          href="https://harshared.lemonsqueezy.com/buy/6db61223-9dff-46dd-ab56-76ca4d711468" // Replace with actual bundle link
          target="_blank"
